...
| 11 | Gemini+Claude `collab_mind`: escalate-when-stuck (critique/guide/takeover) | cursor | done | 2026-09-26: `ai_advisors/collab_mind.py` + ensemble retry + Lanczos rescue; models `gemini-flash-latest` / `claude-sonnet-4-5`; keys gitignored `.env` only — **rotate keys exposed in chat** |
