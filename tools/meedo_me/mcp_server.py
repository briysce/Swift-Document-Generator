...
INSTRUCTIONS = (
    ...
    "advice it has given and what was decided, the outputs it has reviewed, and "
    "the methods that solved past problems. Start a work session with "
    "meedo_standup and decide what it raises. Before diagnosing a problem, call "
